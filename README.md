...
[PCB-Prototyping-Catalogue](https://github.com/aeonSolutions/PCB-Prototyping-Catalogue)  >>   [Home-Automation](https://github.com/aeonSolutions/PCB-Prototyping-Catalogue/tree/main/Home-Automation)  >>  [Home Automation Safety & Health](https://github.com/aeonSolutions/AeonLabs-Safety-Health)   >> Smart Corona Discharge Detector
...
This hardware electronics is now being designed and prototyped in the coming weeks it has the main capability of detecting corona discharges, indoors, in a room. 

Please feel free to come back later for more information and updates about this project. 
